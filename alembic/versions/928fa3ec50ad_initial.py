...
# FIXME: this looks like a not right instructions. In my case there are no tables but we are trying to drop them.
def upgrade() -> None:
    """Upgrade schema."""
...
# TODO: in downgrade we should rollback to previous state on previous revision. In root revision there are no tables.
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table(
