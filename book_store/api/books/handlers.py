...
def create_book_endpoint(book_create: BookCreate, db: Session = Depends(get_session)):
...
def update_book_endpoint(book_id: int, book_update: BookUpdate, db: Session = Depends(get_session)):
...
def delete_book_endpoint(book_id: int, db: Session = Depends(get_session)):
